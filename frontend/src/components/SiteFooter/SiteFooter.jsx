...
export default function SiteFooter({ active = true, dimmed = false }) {
  ...
  return (
    <>
      {active && !visible && (
        <button className={`${styles.fab}${dimmed ? ` ${styles.fabDim}` : ''}`} onClick={() => setVisible(true)} aria-label="Show links & sitemap" title="Links & sitemap">
