...
<head>
  ...
  <style>
    ...
    h2 { font-size: 1.1rem; margin: 28px 0 10px; color: #bce419; }
    ...
    .cta { display: inline-block; margin-top: 8px; padding: 12px 24px; background: #bce419; color: #000; font-weight: 700; border-radius: 8px; text-decoration: none; }
