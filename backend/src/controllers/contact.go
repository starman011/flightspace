...
<html>
<head><meta charset="utf-8"><link href="https://fonts.googleapis.com/css2?family=Lexend+Deca:wght@100..900&amp;display=swap" rel="stylesheet"></head>
...
<table width="100%%" cellpadding="0" cellspacing="0" style="max-width:520px;margin:32px auto;">
  <tr><td style="padding:32px;background:#07101a;border:1px solid #1a2e10;border-radius:16px;">
    <p style="margin:0 0 4px;font-size:10px;font-family:'Lexend Deca',Arial,Helvetica,sans-serif;font-weight:700;letter-spacing:.2em;text-transform:uppercase;color:#bce419;">&#9711; OBJECTTRACER</p>
    <p style="margin:0 0 20px;font-size:9px;font-family:'Lexend Deca',Arial,Helvetica,sans-serif;letter-spacing:.16em;text-transform:uppercase;color:rgba(188,228,25,0.4);">New contact message</p>
    ...
    <p style="margin:0;font-size:12px;color:#3a5060;font-family:'Lexend Deca',Arial,Helvetica,sans-serif;">Reply to: %s</p>
  </td></tr>
</table>
</body>
