...
| 5 | **Mobile DetailPanel hero redesign** | Plane image was skewing on mobile due to `align-items: stretch` forcing `object-fit: cover` to distort. Redesigned as a 56×56 rounded avatar with `align-items: center`, transparent hero background, and text info flowing beside. |
